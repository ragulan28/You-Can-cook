    ...
    return function (e, t, r, a) {
        ...
        var S = function () {
                        ...
                        for (var z in b) {
                            ...
                            if (i(o).isSVG || x.Names.prefixCheck(W)[1] !== !1 || x.Normalizations.registered[W] !== a) {
                                ...
                                if (G = d(z, I), I = G[0], X = G[1], G = d(z, R), R = G[0].replace(/^([+-\/*])=/, function (e, t) {
                                        return Y = t, ""
                                    }), D = G[1], I = parseFloat(I) || 0, R = parseFloat(R) || 0, "%" === D && (/^(fontSize|lineHeight)$/.test(z) ? (R /= 100, D = "em") : /^scale/.test(z) ? (R /= 100, D = "") : /(Red|Green|Blue)$/i.test(z) && (R = R / 100 * 255, D = "")), /[\/*]/.test(Y)) D = X; else if (X !== D && 0 !== I)if (0 === R) D = X; else {
                                    p = p || m();
            ...
            if (g.isWrapped(this) ? (f = !1, m = 0, h = this, d = this) : (f = !0, m = 1, h = l ? arguments[0].elements : arguments[0]), h = o(h)) {
                ...
                if (E.loop = parseInt(E.loop), z = 2 * E.loop - 1, E.loop)for (var q = 0; z > q; q++) {
                    var R = {delay: E.delay};
