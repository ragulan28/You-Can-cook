        ...
        <div class="row ">
            ...
            <div class="col-md-12 center-block ">
                <?PHP
                    ...
                    if (!$con->idOrderInProsserDistribute($id)) {

                        $orders = $con->getNewOrderDistribute();
                        foreach ($orders as $order) {
                            ?>
                            <!-- normal -->
                            <div class="ih-item square effect6 from_top_and_bottom col-lg-8 col-lg-offset-3">
                                <a href="../controller/orderController.php?id=<?PHP echo $order['id'] ?>&distributorId=<?PHP echo $id?>">
