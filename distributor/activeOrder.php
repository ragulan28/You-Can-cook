...
<div class="cd-fold-content single-page ">
    <div class="text-center">
        <?PHP
            ...
            $activeOrder = $con->getActiveOrderDistribute($id);
            //echo $activeOrder['name'];
            if ($activeOrder != -1) {
                ?>
                <h2><?PHP echo $activeOrder['name'] ?></h2>
                <p><?PHP echo $activeOrder['adress'] ?></p>
                <h3 style="color: #761c19"><<< <?PHP echo $activeOrder['no'] ?> >>></h3>
                <a href="../controller/orderController.php?idToFinished=<?PHP echo $activeOrder['id'] ?>&distributorId=<?PHP echo $id ?> "
